...
<div class="w3-row w3-center" style="margin-top: 5%;"> 
	<h1 style="font-weight: 700">THÊM MỚI NHÓM SẢN PHẨM</h1></div>
	...
	<div class="w3-col s12">
		<div style="padding-left: 25%; padding-top: 5%;">
			<input class="w3-input" style="width: 65%;" type="text" name="tennsp" id="tennsp" placeholder="Tên nhóm sản phẩm">
		</div>
		<div style="padding-left: 25%;">
			<input class="w3-input" style="width: 65%;" type="text" name="motansp" id="motansp" placeholder="Mô tả">
		</div>
	...
	<?php
		if(isset($_POST['tennsp'])){
			...
			if($rs){
				?>
				<meta http-equiv="Refresh" content="0,URL=index.php?view=danhsachsanpham" />
				<script type="text/javascript"> alert('Thêm nhóm sản phẩm thành công');</script>
				<?php
			}
		}
	?>
