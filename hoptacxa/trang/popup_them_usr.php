...
<script type="text/javascript">
  $(document).ready(function ()
  {
    ...
    $("#sltinh").blur(function(){
      ...
      $.post("xuly/xuly_them.php", {get_huyen: id_tinh}, function(data){
        $("#slhuyen").html(data);
      });
    });
     ...
     $("#slhuyen").blur(function(){
      ...
      $.post("xuly/xuly_them.php", {get_xa: id_huyen}, function(data){
        $("#slxa").html(data);
      });
    });
    ...
    // });
      $("#ipsdt").keyup(function(){
        ...
        if(sdt.length <10 || sdt.length >11){
             ...
             $.post("xuly/xuly_them.php", {check_sdt: sdt}, function(data){
        $("#canhbao").html(data);
      });
    }
    });
        ...
        var xa = $("#slxa").val();
          if(mail == "" || ten =="" || ho=="" || tinh=="" || huyen=="" || xa==""){
              ...
              $.post("xuly/xuly_them.php", {sdt: sdt, mail: mail, ho: ho, ten: ten,gt: gt, htx: htx,quyen: quyen, tinh: tinh, huyen: huyen, xa: xa}, function(data){
             $("#canhbao").html(data);
      });
    }
    }
