            ...
            if(mysqli_query($conn,$sql)){
              ...
              <?php
					...
					if(isset($_POST['tungdo'])){
						...
						$dd_sdt = $_POST['dd_sdt'];
						$sql = "INSERT INTO HOPTACXA(HTX_TEN,HTX_DIACHI,HTX_SDT,NDD_TEN,NDD_DIACHI,NDD_SDT,HTX_KINHDO,HTX_VIDO)
						VALUES ('$htx_ten','$htx_diachi','$htx_sdt','$dd_ten','$dd_diachi','$dd_sdt',$kinhdo,$vido)";
						mysqli_set_charset($conn,"UTF8");
						if(mysqli_query($conn,$sql)){
							?>
									<script>
