...
<div id="cho_id">
    ...
    <article style="width: 98%; margin-left: 1%; padding-top: 3%;">
      <main  id="table" class="table-editable">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading" style="text-align: center; font-size: 22px; text-transform: uppercase;">Lịch sử giao hàng</div>
 ...
 -->
    ...
    $sql = "SELECT * FROM DONHANG WHERE DH_DVVC_ID = '$dvvc' AND DH_TRANGTHAI = 5 OR DH_TRANGTHAI = 6 OR DH_TRANGTHAI = 7 OR DH_TRANGTHAI = -1 ";
    ?>
        <tbody>
          <?php
        $stt=1;
        ...
        while( $row = mysqli_fetch_array($rs,MYSQLI_ASSOC))
        {
            ...
            <tr>
                ...
                <td><?php echo $row['DH_NGAYNHAN']; ?></td>
                <td><?php if($row['DH_TRANGTHAI'] == 6) echo $row['DH_NGAYGIAO'];  else echo "-";?></td>
                <td><?php echo $row['DH_TONGKHOILUONG']." Kg"; ?></td>
              <!-- -->
              <td>
                <?php
                 if($row['DH_TRANGTHAI'] == -1){
                  echo "Không giao được <br />";
                 echo "<i><b>(". $row['DH_LIDO'].")</b></i> <br />"; 
                 echo "<i>Đã trả hàng</i>";
               } else
                if($row['DH_TRANGTHAI'] == 5){
                  echo "Không giao được <br />";
                 echo "<i><b>(". $row['DH_LIDO'].")</b></i>"; 
               } else {
                    echo "Đã giao hàng";
               }
                 ?>
