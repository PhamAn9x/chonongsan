...
<?php 
  ...
  if(isset($_GET['lsp'])){
    ...
    $nsp = mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM LOAISANPHAM WHERE LSP_ID = $lsp_id"),MYSQLI_ASSOC);
  }
 ?>
</style>
<!DOCTYPE html>
...
<body>
  ...
  <h1 style="text-align: center;" class="box-title">CHỈNH SỬA THÔNG TIN LOẠI SẢN PHẨM</h1>
  <h2 style="text-align: center; font-weight: 800; color: red;">(<?php echo "Loại sản phẩm mã: ".$lsp_id; ?>)</h2>
  <form role="form">
  <div class="row">
    <div class="col-md-6">         
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="email" class="form-control" id="ipten" placeholder="Nhập Email" value="<?php echo $nsp['LSP_TEN']; ?>">
        </div> 
        <div class="form-group">
    ...
    <div class="col-md-6">         
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="ipmota" value="<?php echo $nsp['LSP_MOTA']; ?>" />
        </div>
        <div class="form-group">
