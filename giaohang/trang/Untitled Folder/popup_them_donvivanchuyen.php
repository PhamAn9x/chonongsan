...
<div id="delayedPopup" class="delayedPopupWindow" style="width: 70%; border-radius: 7px;">
    ...
    <h1 style="text-align: center;" class="box-title">THÊM ĐƠN VỊ VẬN CHUYỂN MỚI</h1>
    <form role="form">
        <div class="row">
            <div class="col-md-6">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="ipdvvc_ten" placeholder="Nhập tên đơn vị">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Địa chỉ đơn vị vận chuyển</label>
                        <input type="email" class="form-control" id="ipdvvc_diachi" placeholder="Nhập địa chỉ đơn vị">
                    </div>
            ...
            <div class="col-md-6">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="ipdvvc_sdt" placeholder="Nhập số điện thoại đơn vị">
                    </div>
        ...
        <div class="col-md-12" style="text-align: center;">
            <button style="width: 100px; margin-right: 2%;" id="btnthem_dvvc" type="button" class="btn btn-primary">Thêm</button>
        ...
        $("#btnthem_dvvc").click(function(){
            ...
            if(confirm("Bạn có chắc chắn đã điền đầy đủ?")){
                if(ten=="" || diachi ==""|| sdt=="") alert("Dữ liệu chưa đủ! Vui lòng kiểm tra lại thông tin!");
                    ...
                    $.post("xuly/xuly_them_usr.php", {them_dvvc: flat ,ten: ten, diachi: diachi, sdthoai: sdt}, function(data){
                        $("#pop").html(data);
                    });
                }
            }
