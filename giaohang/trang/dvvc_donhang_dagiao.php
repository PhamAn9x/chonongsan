...
<div id="cho_id">
    ...
    <article style="width: 98%; margin-left: 1%; padding-top: 3%;">
      <main  id="table" class="table-editable">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading" style="text-align: center; font-size: 22px; text-transform: uppercase;">đơn hàng đã giao</div>
 ...
 -->
      ...
      <table id="example2" class="table searchable table-striped table-hover">
        <thead>
          <tr>
            ...
            <th style="width:20px;">Ẩn đơn hàng</th>
          </tr>
        </thead>
           <?php
    session_start();
    ...
    $sql = "SELECT * FROM DONHANG WHERE DH_DVVC_ID = '$dvvc' AND DH_TRANGTHAI = 6";
    ?>
        <tbody>
          <?php
        $stt=1;
