...
class Vector {
	...
	min(mX = this.x, mnY = this.y, mnZ = this.z) {
		...
		this.y = min(this.y, mnY);
		this.z = min(this.z, mnZ);
		return this;
	}
	...
	minX(mX) {
		this.x = min(this.x, mX instanceof Vector ? mX.x : mX);
	}
	minY(mY) {
		this.y = min(this.y, mY instanceof Vector ? mY.y : mY);
	}
	minZ(mZ) {
		this.z = min(this.z, mZ instanceof Vector ? mZ.z : mZ);
	}
	maxX(mX) {
		this.x = max(this.x, mX instanceof Vector ? mX.x : mX);
	}
	maxY(mY) {
		this.y = max(this.y, mY instanceof Vector ? mY.y : mY);
	}
	maxZ(mZ) {
		this.z = max(this.z, mZ instanceof Vector ? mZ.z : mZ);
	}
