...
<div class="tindang" style="width: 90%; margin-left: 5%;">
   <h1 style="text-align: center; font-weight: 700; color: red;">ĐƠN HÀNG ĐÃ GIAO</h1>
   <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
    ...
    <?php
    $dvvc = $_SESSION['sdt'];
    $sql = "SELECT * FROM DONHANG WHERE DH_DVVC_ID = '$sdt' AND DH_TRANGTHAI = 2";
    ?>
    <tbody>
        <?php
        $stt=1;
        ...
        while( $row = mysqli_fetch_array($rs,MYSQLI_ASSOC))
        {
            ...
            <tr>
                ...
                <td>
                    ...
                    <input class="w3-red w3-input w3-hover-white" type="button" name="dagiaodh" id="dagiaodh<?php echo $row['DH_ID']; ?>" value="Xóa">
                </td>
                <td></td>
            </tr>
            <div id = "cho_id"></div>
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    $("#dagiaodh<?php echo $row['DH_ID']; ?>").click(function(){
                        var id = $('#id<?php echo $row['DH_ID']; ?>').val();
                        if(confirm('Bạn có muốn xóa đơn hàng này?')){
                        $.post("process_ajax/ajax_xuly_donhangdagiao.php", {id: id}, function(data){
                            $("#cho_id").html(data);
                        });
                    }
