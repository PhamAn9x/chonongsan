				...
				<table>
					<tr>
						<td>
							...
							<td
								style=" font-size: 16px; font-weight: 800; float:left; margin-top:10px; margin-right: 7px;"><img src="logo_image/ictim.png" width="30px" height="30px"><a href="" style=" text-decoration: none; color: white"> Thích(0)</a>
							</td>
							<td class="w3-border-left w3-border-right" style="font-weight: 600; padding-top: 3px; padding-left: 3px; font-size: 16px;">
								<img style="margin-left:7px;" src="logo_image/icondn.png" width="25px" height="25px"><span style="padding-left: 7px;"><a href="?view=dangnhap" style=" text-decoration: none; color: white;"> Đăng nhập </a></span>  
								<span style="font-size: 17px;">/</span>
								<span style="padding-right:7px;"><a href="?view=dangky" style=" text-decoration: none;color: white;">Đăng ký</a></span>  
							</td>
							<td>
