...
<div style=" padding-bottom: 20%;">
	...
	$slthich = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM THICH WHERE USR_SDT = $sdt"));
		...
		<ul class="mn" id="menu" style=" margin-bottom: 1%; padding-left: 5px; background-color:#0a3d62; z-index: 0;width: 98%;margin-left: 1%;">
			...
			<li><a style="color: yellow;" >&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp NGƯỜI DÙNG <br /><span style="color: white; font-style: italic; margin-left: 2%:">(<?php echo $rs[0].$rs[1]; ?>)</span></a></li>
			<li><a href="index.php?view=ql_donhang">Đơn hàng</a></li>
			<li><a href="index.php?view=ql_lichsu">Lịch sử đơn hàng</a></li>
...
if(isset($_GET['view']) != "dangnhap" && isset($_GET['view']) != "dangky"){
	...
	if(!isset($_GET['view'])){
		...
		?>
		<div class="w3-col s12" style=" margin-left:2.5%; ">
			<?php 
			$view = $_GET['view'];
	...
	?>
	<div class="w3-col s12" style="text-align: center; padding-left: 5%;">
		<?php 
		if(!isset($_GET['view']) && !isset($_GET['xem']))
		{
