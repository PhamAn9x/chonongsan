...
<body>
  ...
  <h1 style="text-align: center;" class="box-title">CHỈNH SỬA THÔNG TIN NHÓM SẢN PHẨM</h1>
  <h2 style="text-align: center; font-weight: 800; color: red;">(<?php echo "Nhóm sản phẩm mã: ".$manhom; ?>)</h2>
  <form role="form">
  <div class="row">
    <div class="col-md-6">         
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="email" class="form-control" id="ipten" placeholder="Nhập Email" value="<?php echo $nsp['NSP_TEN']; ?>">
        </div> 
        <div class="form-group">
    ...
    <div class="col-md-6">         
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="ipmota" value="<?php echo $nsp['NSP_MOTA']; ?>" />
        </div>
        <div class="form-group">
