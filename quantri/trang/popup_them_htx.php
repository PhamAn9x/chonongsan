...
<body>
  ...
  <h1 style="text-align: center;" class="box-title">THÊM MỚI HỌP TÁC XÃ</h1>
  <form role="form">
  <div class="row">
    <div class="col-md-6">
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="ipten_htx" placeholder="Nhập tên hợp tác xã">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Địa chỉ</label>
          <input type="text" class="form-control" id="iphtx_diachi" placeholder="Nhập số địa chỉ hợp tác xã" />

        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Số điện thoại hợp tác xã</label>
          <input type="text" class="form-control" id="iphtx_sdt" placeholder="Nhập số điện thoại hợp tác xã" />
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6">
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="ipten_dd" placeholder="Nhập tên người đại diện" />
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Địa chỉ người đại diện</label>
          <input type="text" class="form-control" id="ipdiachi_dd" placeholder="Nhập địa chỉ người đại diện" />
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Số điện thoại người đại diện</label>
          <input type="text" class="form-control" id="ipsdt_dd" placeholder="Nhập địa chỉ người đại diện" />
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Ngày sinh người đại diện</label>
          <input type="date" class="form-control" id="ipngaysinh_dd" placeholder="Nhập địa chỉ người đại diện" />
        </div>
      </div>
      </div>
    </div>
<div class="col-md-12" style="text-align: center;">
   <button style="width: 100px; margin-right: 2%;" id="btnthem_htx" type="button" class="btn btn-primary">Thêm</button>
    ...
    $("#btnthem_lsp").click(function(){
       ...
       if(confirm("Bạn có chắc chắn đã điền đầy đủ?")){
        if(ten=="" || mota=="") alert("Dữ liệu chưa đủ! Vui lòng kiểm tra lại thông tin!");
               ...
               $.post("xuly/xuly_them_usr.php", {them_lsp: flat,ten: ten, mota: mota, nsp: nsp}, function(data){
                            $("#pop").html(data);
                        });
          }
      }
...
<script>
  $(document).ready(function(){
    $("#btnthem_htx").click(function(){
      ...
      var dd_ngaysinh =$("#ipngaysinh_dd").val();
      $.post("xuly/xuly_them_usr.php", {tungdo: tungdo,vido: vido, htx_ten: htx_ten, htx_diachi: htx_diachi, htx_sdt: htx_sdt, dd_ten: dd_ten, dd_diachi: dd_diachi, dd_sdt: dd_sdt,ngaysinh: dd_ngaysinh}, function(data){
                   $("#pop").html(data);
               });
