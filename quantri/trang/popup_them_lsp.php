...
<body>
  ...
  <h1 style="text-align: center;" class="box-title">THÊM LOẠI SẢN PHẨM MỚI</h1>
  <form role="form">
  <div class="row">
    <div class="col-md-6">         
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="email" class="form-control" id="ipten" placeholder="Nhập tên loại sản phẩm">
        </div> 
        <div class="form-group">
...
<div class="box-body">
        <div class="form-group">
          ...
          <select type="text" class="form-control" id="slnsp">
...
<div class="col-md-12" style="text-align: center;">
   <button style="width: 100px; margin-right: 2%;" id="btnthem_lsp" type="button" class="btn btn-primary">Thêm</button>
